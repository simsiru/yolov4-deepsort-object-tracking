from utils import get_and_save_person_face_embeddings, get_and_save_person_face_depth_maps, \
    delete_person_face_embeddings, view_face_embeddings, insert_delete_update_person_face_data_in_database
...
if __name__ == "__main__":
    ...
    insert_delete_update_person_face_data_in_database(n_img_class = 10, save_face_img = True, face_img_path = "face_img_data")
